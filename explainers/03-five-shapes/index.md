---
title: Five Shapes
description: Five questions any real change has to answer, and the differently shaped answers they need.
date: 2026-08-15
showHero: true
---
...
Not what's wrong. What does success actually look like — and what has to be true for it to be possible at all?
...
<figure>
<svg viewBox="0 0 560 200" style="width:100%;max-width:520px;height:auto;display:block;margin:0 auto;" role="img" aria-label="A goal at the top, resting on three necessary conditions">
  <text x="10" y="18" font-size="11" font-weight="700" fill="#666">THE GOAL, AND WHAT IT RESTS ON</text>
  <rect x="140" y="30" width="280" height="46" rx="4" fill="none" stroke="#c25c34" stroke-width="2.5"/>
  <text x="280" y="58" text-anchor="middle" font-size="12.5" font-family="sans-serif" fill="#c25c34">everyone who needs to be seen is seen, and does not come back</text>
  <g font-family="sans-serif" font-size="11" fill="#333">
    <rect x="20" y="140" width="150" height="46" rx="4" fill="none" stroke="#333" stroke-width="2"/>
    <text x="95" y="167" text-anchor="middle">enough appointments</text>
    <rect x="205" y="140" width="150" height="46" rx="4" fill="none" stroke="#333" stroke-width="2"/>
    <text x="280" y="160" text-anchor="middle">consultations good</text>
    <text x="280" y="174" text-anchor="middle">enough to not repeat</text>
    <rect x="390" y="140" width="150" height="46" rx="4" fill="none" stroke="#333" stroke-width="2"/>
    <text x="465" y="167" text-anchor="middle">staff who stay</text>
  </g>
  <line x1="95" y1="140" x2="230" y2="76" stroke="#999" stroke-width="1.5"/>
  <line x1="280" y1="140" x2="280" y2="76" stroke="#999" stroke-width="1.5"/>
  <line x1="465" y1="140" x2="330" y2="76" stroke="#999" stroke-width="1.5"/>
</svg>
<figcaption>Figure 1 · The goal, and the few conditions non-negotiable for reaching it. This sentence rules out seeing more people faster if they return — it says the ten-minute rule is a bet the clinic had never checked.</figcaption>
</figure>
...
Waits too long. Staff exhausted. Same patients returning. Referrals late.

The instinct is to fix these one by one, and that instinct is the trap. They aren't four problems. They are four fingerprints — and if you treat the fingerprints you will be back here in a year with the same four.
...
### 3 · So why hasn't somebody already fixed it?
...
<figure>
<svg viewBox="0 0 620 240" style="width:100%;max-width:560px;height:auto;display:block;margin:0 auto;" role="img" aria-label="A conflict diagram: serving the catchment needs both enough appointments and consultations that hold up, but ten-minute slots and longer slots pull in opposite directions">
  <text x="10" y="18" font-size="11" font-weight="700" fill="#666">THE CONFLICT</text>
  <rect x="15" y="90" width="110" height="60" rx="4" fill="none" stroke="#333" stroke-width="2"/>
  <text x="70" y="115" text-anchor="middle" font-size="11" font-family="sans-serif">serve the</text>
  <text x="70" y="129" text-anchor="middle" font-size="11" font-family="sans-serif">catchment</text>
  <rect x="185" y="40" width="150" height="46" rx="4" fill="none" stroke="#333" stroke-width="2"/>
  <text x="260" y="67" text-anchor="middle" font-size="11" font-family="sans-serif">see enough people</text>
  <rect x="185" y="154" width="150" height="46" rx="4" fill="none" stroke="#333" stroke-width="2"/>
  <text x="260" y="174" text-anchor="middle" font-size="11" font-family="sans-serif">consultations that</text>
  <text x="260" y="188" text-anchor="middle" font-size="11" font-family="sans-serif">hold up</text>
  <rect x="395" y="40" width="140" height="46" rx="4" fill="none" stroke="#c25c34" stroke-width="2.5"/>
  <text x="465" y="67" text-anchor="middle" font-size="11" font-family="sans-serif" fill="#c25c34">ten-minute slots</text>
  <rect x="395" y="154" width="140" height="46" rx="4" fill="none" stroke="#c25c34" stroke-width="2.5"/>
  <text x="465" y="181" text-anchor="middle" font-size="11" font-family="sans-serif" fill="#c25c34">longer slots</text>
  <line x1="125" y1="112" x2="185" y2="75" stroke="#999" stroke-width="1.5"/>
  <line x1="125" y1="128" x2="185" y2="168" stroke="#999" stroke-width="1.5"/>
  <line x1="395" y1="63" x2="335" y2="63" stroke="#999" stroke-width="1.5"/>
  <line x1="395" y1="177" x2="335" y2="177" stroke="#999" stroke-width="1.5"/>
  <rect x="350" y="100" width="220" height="40" rx="4" fill="none" stroke="#c25c34" stroke-width="1.5" stroke-dasharray="4 4"/>
  <text x="460" y="115" text-anchor="middle" font-size="9.5" font-family="sans-serif" fill="#c25c34" letter-spacing="0.5">THE ASSUMPTION</text>
  <text x="460" y="130" text-anchor="middle" font-size="10.5" font-family="sans-serif" fill="#c25c34">consultation length is the only lever</text>
</svg>
<figcaption>Figure 2 · Both requirements are real; both actions are reasonable. What keeps them opposed is one written assumption — and it may not be true.</figcaption>
</figure>
...
*Consultation length is the only lever on quality.* Is that true? Or does a consultation overrun because the history was taken twice and the notes weren't there — in which case the lever isn't the clock at all. It's the notes.
...
You have an idea: fix the notes, leave the ten minutes alone.

Before you spend a year on it, walk it forwards. If the notes are ready, then the history isn't re-taken. If the history isn't re-taken, then the consultation fits. If it fits, then Dr Adeyemi isn't writing up at seven — so tomorrow's notes are ready too.

That last step matters, because it means the thing compounds. Quite a lot of good ideas die right here instead, on paper, for free.

Then the question people skip because they don't want the answer: **what else does it do?**

Ready notes mean someone has to prepare them. That is forty minutes of somebody's morning, and the obvious somebody is Maria, who has no forty minutes. Find that now, while it is hypothetical and costs nothing, rather than in March when it quietly kills the whole thing.

### 5 · What do we do on Monday, and in what order?
...
| Obstacle | What has to exist to get past it |
|---|---|
| The summarising has to happen before eight | Someone doing it before the doors open |
| The person who could do it is already the busiest in the building | Free that time, or find someone else |
| The clinic has money for exactly one hire | Spend it on notes, not the desk |
