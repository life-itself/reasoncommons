...
description: Sixty people are waiting and everybody knows where the problem is. They are all wrong.
date: 2026-08-15
showHero: true
---
...
<figure>
<svg viewBox="0 0 640 260" style="width:100%;max-width:640px;height:auto;display:block;margin:0 auto;" role="img" aria-label="Five stations with daily capacities; work backs up in front of the doctor and output stops at twenty">
  <text x="10" y="20" font-size="11" font-weight="700" fill="#666">FIVE STATIONS · ONE LIMIT</text>
  ...
  <text x="620" y="112" font-size="34" font-weight="700" text-anchor="end" fill="#c25c34">20</text>
  <text x="620" y="132" font-size="10" text-anchor="end" fill="#777" letter-spacing="1">PER DAY</text>
</svg>
<figcaption>Figure 1 · Every other station can handle at least twice what the doctor can — so the clinic treats twenty a day. Not forty, which is what it would manage if the doctor's station matched the next tightest one. Twenty.</figcaption>
</figure>
...
<figure>
<svg viewBox="0 0 620 170" style="width:100%;max-width:560px;height:auto;display:block;margin:0 auto;" role="img" aria-label="Dr Adeyemi's eight-hour day: six hours with patients, two lost to admin">
  <text x="10" y="18" font-size="11" font-weight="700" fill="#666">DR ADEYEMI'S DAY · 8 HOURS</text>
  <g>
    <rect x="10" y="34" width="450" height="44" rx="4" fill="none" stroke="#333" stroke-width="2"/>
    <rect x="10" y="34" width="450" height="44" fill="#333" opacity="0.06"/>
    <text x="235" y="61" font-size="13" text-anchor="middle" fill="#333">six hours with patients — twenty seen</text>
    <rect x="460" y="34" width="150" height="44" rx="4" fill="none" stroke="#c25c34" stroke-width="2.5" stroke-dasharray="5 4"/>
    <text x="535" y="61" font-size="12" text-anchor="middle" fill="#c25c34">two hours: admin</text>
  </g>
  <g>
    <text x="10" y="112" font-size="12" fill="#777">Recover the two hours at the same pace —</text>
    <text x="705" y="112" font-size="12" fill="#777" text-anchor="end"></text>
  </g>
  <rect x="10" y="122" width="600" height="44" rx="4" fill="none" stroke="#c25c34" stroke-width="2.5"/>
  <text x="20" y="150" font-size="13" fill="#333">eight hours with patients, none lost to admin — <tspan font-weight="700" fill="#c25c34">twenty-six seen</tspan></text>
</svg>
<figcaption>Figure 2 · Six of eight hours are clinical; twenty patients in that time is a shade under eighteen minutes each. Give back the two admin hours at the same rate and the same day yields twenty-six — for nothing.</figcaption>
</figure>
...
<figure>
<svg viewBox="0 0 620 190" style="width:100%;max-width:560px;height:auto;display:block;margin:0 auto;" role="img" aria-label="Rules pinned to a noticeboard, layered like sediment into a reef">
  <text x="10" y="18" font-size="11" font-weight="700" fill="#666">A CORAL REEF OF PROCEDURES</text>
  <g font-family="sans-serif" font-size="10.5" fill="#777">
    <rect x="15" y="34" width="150" height="60" rx="3" fill="#efe9dd" stroke="#999" stroke-width="1.5"/>
    <text x="90" y="68" text-anchor="middle">COUNTERSIGN ALL SCRIPTS</text>
    <rect x="185" y="30" width="150" height="60" rx="3" fill="#efe9dd" stroke="#999" stroke-width="1.5"/>
    <text x="260" y="64" text-anchor="middle">10 MIN MAX</text>
    <rect x="355" y="36" width="150" height="60" rx="3" fill="#efe9dd" stroke="#999" stroke-width="1.5"/>
    <text x="430" y="70" text-anchor="middle">REFERRALS: THURS</text>
    <rect x="100" y="110" width="150" height="60" rx="3" fill="#e6dfd0" stroke="#888" stroke-width="1.5"/>
    <text x="175" y="144" text-anchor="middle">FORMS IN TRIPLICATE</text>
    <rect x="290" y="106" width="150" height="60" rx="3" fill="#e6dfd0" stroke="#888" stroke-width="1.5"/>
    <text x="365" y="140" text-anchor="middle">STOCK ORDERED MONTHLY</text>
  </g>
</svg>
<figcaption>Figure 3 · Every rule was installed for a good reason, usually to solve a problem nobody now remembers. Organisations accumulate procedures the way a reef accumulates coral — laid down in layers, each for a purpose, long after the purpose has gone.</figcaption>
</figure>
