---
title: The Wrong Queue — plain version
description: Sixty people are waiting and everybody knows where the problem is. They are all wrong. A static, non-scrolling telling.
date: 2026-08-30
---
...
![A hand-drawn clinic with a queue of people trailing out of the door. Pencil lines from all over the building converge on the front-desk window, which is circled in orange.](img/clinic-pointing.png)
...
![Nine rule cards pinned to a board — COUNTERSIGN ALL SCRIPTS, 10 MIN MAX, REFERRALS: THURSDAYS, NO SAME-DAY BOOKING, FORMS IN TRIPLICATE, and more. A band of coral-like arcs grows up from underneath them.](img/reef.png)
