...
| **Explainers v2** — the rework into short illustrated chapters, run by scheduled sessions | `docs/plans/2026-09-18-explainers-v2.md`; state in beads (`bd ready --label explainers-v2`); runner in `scripts/explainer-loop/` |
