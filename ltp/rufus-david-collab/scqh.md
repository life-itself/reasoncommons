...
5. Rufus and David shortlist funders: Coefficient Giving (formerly Open Philanthropy) and the Survival and Flourishing Fund so far, with others found by research or by asking around. Expected: a shortlist with what each funder asks for and when. Draft shortlist in [funders.md](funders.md), 2026-09-26: Foresight Institute first (deadline 2026-10-31), then SFF's rolling application, then asking Coefficient Giving and the Future of Life Foundation.
